...
export default function GallerySection() {
  ...
  const galleryImages = [
    { src: "/placeholder.svg?height=400&width=600", alt: "Event Image 1", span: "col-span-2 row-span-2" }, // Wider landscape
    { src: "/placeholder.svg?height=500&width=300", alt: "Event Image 2", span: "col-span-1 row-span-2" }, // Taller portrait
    { src: "/placeholder.svg?height=300&width=300", alt: "Event Image 3", span: "col-span-1 row-span-1" }, // Square
    { src: "/placeholder.svg?height=200&width=800", alt: "Event Image 4", span: "col-span-2 row-span-1" }, // Very wide panorama
    { src: "/placeholder.svg?height=400&width=400", alt: "Event Image 5", span: "col-span-1 row-span-1" }, // Square
    { src: "/placeholder.svg?height=600&width=400", alt: "Event Image 6", span: "col-span-1 row-span-2" }, // Taller portrait
    { src: "/placeholder.svg?height=300&width=500", alt: "Event Image 7", span: "col-span-1 row-span-1" }, // Wider landscape
    { src: "/placeholder.svg?height=250&width=750", alt: "Event Image 8", span: "col-span-2 row-span-1" }, // Wide panorama
  ]
          ...
          {galleryImages.map((image, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <span className="text-white text-lg font-poppins opacity-0 group-hover:opacity-100 transition-opacity delay-100">
                  View Event
                </span>
              </div>
            </div>
